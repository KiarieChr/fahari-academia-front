  ...
  return (
    <DashboardLayout title="Student Settings">
      <div className="flex flex-col gap-5 px-1 py-2 pb-16 min-h-screen">
        ...
        {/* ── Page Header ─────────────────────────────────────────── */}
        <div className="relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-gradient-to-br from-white via-white to-indigo-50/30 border border-gray-100 rounded-2xl px-10 py-7 shadow-[0_2px_16px_rgba(0,0,0,0.05)]">
          {/* Decorative accents */}
        ...
        <div className="flex gap-5 min-h-[560px]">
          ...
          <div className="flex-shrink-0 w-60 bg-white border border-gray-100 rounded-2xl shadow-[0_1px_4px_rgba(0,0,0,0.06)] self-start sticky top-4">
            {/* Top accent */}
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      group relative flex items-center gap-3 w-full pl-5 pr-4 py-3 rounded-xl text-[0.82rem] font-medium
          ...
          <div className="flex-1 min-w-0 flex flex-col bg-white border border-gray-100 rounded-2xl shadow-[0_1px_6px_rgba(0,0,0,0.04)] overflow-hidden">
            ...
            <div className="flex items-center justify-between px-8 py-4 border-b border-gray-100/80 bg-gray-50/40">
