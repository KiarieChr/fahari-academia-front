...
import { X, Save, User, BookOpen, History } from 'lucide-react';
...
const StudentEditModal = ({ isOpen, onClose, studentId, onSuccess }) => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Helper to get ID from potential object or value
            const getId = (val) => {
                if (!val) return null;
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <h2 className="text-xl font-semibold text-gray-900">
                        {student ? `Edit ${student.student_name}` : 'Edit Student'}
                    </h2>
                    <button
                        onClick={onClose}
                ...
                <div className="flex border-b border-gray-200 px-6">
                    ...
                    <button
                        className={`py-3 px-4 text-sm font-medium border-b-2 transition-colors ${activeTab === 'enrollment' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700'}`}
