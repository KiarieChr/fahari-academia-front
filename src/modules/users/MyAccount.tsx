...
const MyAccount = ({ noLayout = false }) => {
        ...
        try {
            ...
            if (Array.isArray(sessions)) {
                setActiveSessions(sessions.map(s => ({
                    ...
                    isSameNetwork: s.is_same_network || false,
                    label: s.label || '',
                })));
            } else {
                setActiveSessions([]);
                                                    ...
                                                    <div className="security-section">
                                                        <div className="section-header">
                                                            <div className="header-content">
                                                                ...
                                                                <div>
                                                                    <h3 className="section-title">Session Timeout</h3>
                                                                    <p className="section-subtitle">Automatically log out after inactivity</p>
                                                                </div>
                                                            </div>
                                                            <div className="toggle-wrapper">
                                                                <select 
                                                                    ...
                                                                    onChange={(e) => {
                                                                        handleProfileUpdate('sessionTimeout', parseInt(e.target.value));
                                                                        // Auto-save the new timeout to backend
                                                            ...
                                                            <div className="session-header">
                                                                <div className="session-info">
                                                                    <div className="session-device">
                                                                        ...
                                                                        ) : session.isSameNetwork ? (
                                                                            <span className="current-badge" style={{ backgroundColor: '#e8f5e9', color: '#4caf50' }}>Same Network</span>
                                                                        ) : null}
                                                                    </div>
