...
const Procurement = ({ noLayout = false, navigate }) => {
    let reactRouterNavigate;
    try {
        reactRouterNavigate = useNavigate();
    } catch (e) {
        // Ignored in Next.js environment
    }
    const localNavigate = navigate || reactRouterNavigate || ((path) => {
                ...
                <div className="w-64 bg-white border-r border-gray-200 overflow-y-auto hidden md:block">
                    <div className="p-4">
                        ...
                        <nav className="space-y-1">
                            ...
                            <button
                                onClick={() => localNavigate('/dashboard/procurement/inventory')}
