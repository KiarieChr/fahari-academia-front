    ...
    return (
        <div className="p-6 space-y-6">
                ...
                <div className="flex flex-wrap gap-3 mt-3 mb-3">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 text-indigo-700 rounded-full text-xs font-semibold p-1">
                        <Layers size={13} /> {templates.length} Total
                    </span>
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 text-green-700 rounded-full text-xs font-semibold p-1">
                        <CheckCircle2 size={13} /> {activeCount} Active
                    </span>
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-amber-50 text-amber-700 rounded-full text-xs font-semibold p-1">
                        <AlertCircle size={13} /> {draftCount} Draft
                    </span>
                </div>

                {/* ── Filters ──────────────────────────── */}
                <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', padding: '0.75rem 1rem',marginBottom: '15px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'nowrap' }}>
                        {/* Label */}
                        <div style={{ display: 'flex', alignItems: 'center', gap: '5px', fontSize: '0.8rem', color: '#94a3b8', fontWeight: 600, whiteSpace: 'nowrap', flexShrink: 0 }}>
                        ...
                        <div style={{ position: 'relative', flex: 1, minWidth: 0 }}>
                            ...
                            <input
                                ...
                                style={{ width: '100%', paddingLeft: '32px', paddingRight: '10px', paddingTop: '7px', paddingBottom: '7px', borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '0.82rem', outline: 'none', background: '#f8fafc', color: '#1e293b', boxSizing: 'border-box' }}
                            />
                        </div>
                        {/* Year */}
                        <select
                            ...
                            style={{ flexShrink: 0, width: '130px', padding: '7px 10px', borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '0.82rem', background: '#f8fafc', color: '#1e293b', outline: 'none' }}
                        >
                        ...
                        <select
                            ...
                            style={{ flexShrink: 0, width: '120px', padding: '7px 10px', borderRadius: '8px', border: '1px solid #e2e8f0', fontSize: '0.82rem', background: '#f8fafc', color: '#1e293b', outline: 'none' }}
                        >
                ...
                <style>{`
                    ...
                    @media (min-width: 640px) {
                        .fee-template-grid { grid-template-columns: repeat(2, 1fr); }
                    }
                    @media (min-width: 1024px) {
                        .fee-template-grid { grid-template-columns: repeat(3, 1fr); }
                    }
                `}</style>
                {loading ? (
                    ...
                    <div className="fee-template-grid">
                        {templates.map(tpl => (
                            <FeeTemplateCard
                                key={tpl.id}
                                template={tpl}
...
export { FeeTemplateDashboard as FeeTemplateTab };
