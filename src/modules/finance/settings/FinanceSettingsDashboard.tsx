...
import SponsorshipSettings from './components/SponsorshipSettings';
...
const FinanceSettingsDashboard = () => {
    ...
    const sections = [
        ...
        { id: 'sponsorships', label: 'Sponsorships & Sponsors', icon: Briefcase, description: 'Sponsors & clearing accounts' },
    ...
    const renderContent = () => {
        ...
        switch (activeSection) {
            ...
            case 'sponsorships':
                return <SponsorshipSettings accounts={settingsData.accounts} />;
            case 'other':
