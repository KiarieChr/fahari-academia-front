            ...
            <div className="p-4 border-b border-slate-200 dark:border-slate-700 flex flex-col md:flex-row gap-4 justify-between items-center bg-slate-50/50 dark:bg-slate-900/50">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <div className="relative">
                        ...
                        <select
                            style = {{ paddingLeft: '30px'}}
                            className="pr-8 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none appearance-none font-medium"
                            value={filterClass}
