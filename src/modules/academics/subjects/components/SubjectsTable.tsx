                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex flex-wrap gap-1 max-w-[200px]">
                                            {subject.classes.slice(0, 2).map((cls, i) => (
                                                <span key={i} className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-700 rounded text-[10px] font-bold text-slate-600 dark:text-slate-300">
                                                    {cls}
                                                </span>
                                            ))}
                                            {subject.classes.length > 2 && (
                                                <span className="px-1.5 py-0.5 bg-slate-100 dark:bg-slate-700 rounded text-[10px] text-slate-400">
                                                    +{subject.classes.length - 2}
                                                </span>
                                            )}
                                        </div>
