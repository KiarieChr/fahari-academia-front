                    ...
                    return (
                        <div key={index} className="pb-6 border-b border-gray-50 last:border-0 last:pb-0">
                            <div className="flex justify-between items-center mb-2">
                                <span className="font-semibold text-gray-800 text-sm">{balance.type}</span>
                                <span className="text-xs font-medium text-gray-500">{balance.used} / {balance.total} days</span>
                            </div>

                            <div className="balance-progress-bar mb-2">
                                <div
                                    className={`balance-progress-fill ${balance.color}`}
                                    style={{ width: `${percentage}% ` }}
                                ></div>
                            </div>

                            <div className="flex justify-between text-xs text-gray-500">
                                <span>Used: <span className="text-gray-700 font-medium">{balance.used} days</span></span>
