        ...
        <div className="grid grid-cols-2 gap-4 h-full">
            {actions.map((action, index) => (
                <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="quick-action-btn flex flex-col items-center justify-center p-4 bg-white border border-slate-200 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-200 transition-all group h-auto min-h-[120px]"
                >
