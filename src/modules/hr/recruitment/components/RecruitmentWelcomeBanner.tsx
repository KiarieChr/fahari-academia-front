...
const RecruitmentWelcomeBanner = ({ newApplicationsCount = 0, userName = 'HR' }) => {
    return (
        <motion.div 
            ...
            className="relative bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 sm:p-8 overflow-hidden shadow-lg mb-6"
        >
            {/* Background pattern */}
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6">
                <div className="text-white max-w-xl">
                    ...
                    <button className="text-sm font-semibold text-white underline decoration-blue-300 hover:decoration-white transition-all underline-offset-4">
                        review it!
                    </button>
                </div>
