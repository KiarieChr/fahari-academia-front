...
// Reuse existing components from class-sessions
import TimetableGrid from '../students/class-sessions/components/TimetableGrid';
import TimetableFilters from '../students/class-sessions/components/TimetableFilters';
import TimetableStats from '../students/class-sessions/components/TimetableStats';
import TimePeriodsPanel from '../students/class-sessions/components/TimePeriodsPanel';
import WorkAllocationsPanel from '../students/class-sessions/components/WorkAllocationsPanel';
import CreateEditTimetableModal from '../students/class-sessions/components/modals/CreateEditTimetableModal';
import ViewTimetableModal from '../students/class-sessions/components/modals/ViewTimetableModal';
...
const TimetableDashboard = () => {
    ...
    const [activeTab, setActiveTab] = useState(() => {
        ...
        return TABS.find(t => t.id === tab) ? tab : 'timetable';
    });
